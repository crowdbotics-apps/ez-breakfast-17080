"""ez_breakfast_17080 URL Configuration
...
admin.site.site_header = "ez breakfast"
admin.site.site_title = "ez breakfast Admin Portal"
admin.site.index_title = "ez breakfast Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="ez breakfast API",
        default_version="v1",
        description="API documentation for ez breakfast App",
    ),
    public=True,
